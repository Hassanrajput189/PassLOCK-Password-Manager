        ...
        <>
            ...
            <div className="p-3 md:mycontainer min-h-[88.2vh]">
                <h1 className='text-4xl font-bold text-center'>
                    ...
                    <span>Pass</span><span className='text-blue-500'>LOCK/&gt;</span>
                </h1>
                ...
                <div className="flex flex-col p-4 text-black gap-8 items-center">
                    ...
                    <button onClick={savePassword} className='flex justify-center items-center gap-2 bg-blue-400 hover:bg-blue-300 rounded-full px-8 py-2 w-fit border border-blue-900'>
                        <lord-icon src="/icons/save.json" trigger="hover"></lord-icon>
                        Save
                    </button>
                </div>
                                    ...
                                    <tr key={item.id}>
                                        <td className='py-2 border border-white text-center'>
                                            <div className='flex items-center justify-center'>
                                                ...
                                                <div className='lordiconcopy size-7 cursor-pointer' onClick={() => copyText(item.site)}>
                                                    <lord-icon style={{ "width": "25px", "height": "25px", "paddingTop": "3px", "paddingLeft": "3px" }} src="/icons/copy.json" trigger="hover"></lord-icon>
                                                </div>
                                            </div>
                                        </td>
                                        <td className='py-2 border border-white text-center'>
                                        ...
                                        <td className='py-2 border border-white text-center'>
                                            <div className='flex items-center justify-center'>
                                                ...
                                                <span className='cursor-pointer' onClick={() => showTablePassword(item.id)}>
                                                    <img className="p-1" width={26} src={visiblePasswords[item.id] ? "/icons/eyecross.png" : "/icons/eye.png"} alt="eye" />
                                                </span>
                                        ...
                                        <td className='py-2 border border-white text-center'>
                                            <div className='flex items-center justify-center gap-2'>
                                                <div className='lordiconedit size-7 cursor-pointer' onClick={() => editPassword(item.id)}>
                                                    <lord-icon style={{ "width": "25px", "height": "25px", "paddingTop": "3px", "paddingLeft": "3px" }} src="/icons/edit.json" trigger="hover"></lord-icon>
                                                </div>
                                                <div className='lordicondelete size-7 cursor-pointer' onClick={() => deletePassword(item.id)}>
                                                    <lord-icon style={{ "width": "25px", "height": "25px", "paddingTop": "3px", "paddingLeft": "3px" }} src="/icons/delete.json" trigger="hover"></lord-icon>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
